...
class SongInputAudioConfig(BaseModel):
    ...
    audio: AudioConfig = AudioConfig.input(label="Stemming")
    vocals: AudioConfig = AudioConfig.input(label="Vocal Conversion")
    converted_vocals: AudioConfig = AudioConfig.input(label="Vocal Post")
...
class MultiStepSongGenerationConfig(SongGenerationConfig):
    ...
    separation_model: DropdownConfig = DropdownConfig(
        ...
        value=SeparationModel.MDX23C_INSTVOC_HQ,
