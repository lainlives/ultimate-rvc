...
from ultimate_rvc.typing_extra import (AudioExt, AudioNormalizationMode,
                                       AudioSplitMethod, EmbedderModel,
                                       F0Method, IndexAlgorithm, PrecisionType,
                                       PretrainedType, SampleRate,
                                       TrainingSampleRate, Vocoder)
from ultimate_rvc.web.config.component import (CheckboxConfig, DropdownConfig,
                                               NumberConfig, SliderConfig,
                                               TextboxConfig)
from ultimate_rvc.web.typing_extra import (DatasetType, SongSourceType,
                                           SpeechSourceType)
...
class TrainingConfig(BaseTabConfig):
    ...
    dataset_type: DropdownConfig = DropdownConfig(
        ...
        value=DatasetType.EXISTING_DATASET,
    ...
    sample_rate: DropdownConfig = DropdownConfig(
        ...
        value=TrainingSampleRate.HZ_44K,
    ...
    normalization_mode: DropdownConfig = DropdownConfig(
        ...
        value=AudioNormalizationMode.NONE,
