...
def load_embedding(embedder_model, custom_embedder=None):
    ...
    embedding_list = {
        ...
        "wavlm-base-plus": os.path.join(embedder_root, "wavlm-base-plus"),
        "wavlm-plus-ft": os.path.join(embedder_root, "wavlm-plus-ft"),
        "wavLM-SPIN": os.path.join(embedder_root, "wavLM-SPIN-2048_11_12"),
        "KLM-Vocal-X1": os.path.join(embedder_root, "KLM-Vocal-X1"),
        "Deep_WavLM_ft": os.path.join(embedder_root, "7_12_2048_WavLM"),
