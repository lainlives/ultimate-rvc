...
class SeparationModel(StrEnum):
    ...
    MDX23C_INSTVOC_HQ = "melband_roformer_instvox_duality_v2.ckpt"
    MELBAND_DEBLEED = "mel_band_roformer_denoise_debleed_gabox.ckpt"
...
class EmbedderModel(StrEnum):
    ...
    SPIN = "spin"
    SPIN_V2 = "spin-v2"
    WAVLM_PLUS_FT = "wavlm-plus-ft"
    WAVLM_BASE_PLUS = "wavlm-base-plus"
    DEEP_WAVLM = "Deep_WavLM_ft"
    WAVLM_SPIN = "wavLM-SPIN"
    KLM_VOCAL_X1 = "KLM-Vocal-X1"
