...
def run_pipeline(
    ...
    vocals_track, instrumentals_track = separate_audio(
        song,
        song_dir,
        SeparationModel.MDX23C_INSTVOC_HQ,
        SegmentSize.SEG_2048,
    )
    main_vocals_track = vocals_track
    backup_vocals_track = vocals_track
    # display_progress(
    #     "[~] Debleeding vocals...",  # "[~] Separating main vocals from backup vocals...",
    #     2 / 9,
    #     progress_bar,
    # )
    ...
    #     vocals_track,
    #     song_dir,
    #     SeparationModel.MELBAND_DEBLEED,  # UVR_MDX_NET_KARA_2,
    #     SegmentSize.SEG_2048,
    # )
